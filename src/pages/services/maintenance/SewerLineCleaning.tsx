...
const SewerLineCleaning = () => {
  ...
  return (
    <div className="min-h-screen pb-20 animate-fade-in">
      <Helmet>
        <title>Sewer Line Cleaning Fresno, CA | Prevent Backups</title>
        <meta name="description" content="Sewer line cleaning maintenance in Fresno: video inspection, hydro-jetting. Licensed plumbers, 79 years experience. Call (559) 292-4065!" />
        <link rel="canonical" href="https://fresno.plumbing/services/maintenance/sewer-line-cleaning" />
      </Helmet>
