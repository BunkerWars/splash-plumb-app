...
const DrainCleaning = () => {
  ...
  return (
    <div className="min-h-screen pb-20 animate-fade-in">
      <Helmet>
        <title>Drain Cleaning Maintenance Fresno, CA | Preventive Service</title>
        <meta name="description" content="Regular drain cleaning maintenance in Fresno: prevent clogs, keep drains flowing. Licensed plumbers, 79 years experience. Call (559) 292-4065!" />
        <link rel="canonical" href="https://fresno.plumbing/services/maintenance/drain-cleaning" />
      </Helmet>
