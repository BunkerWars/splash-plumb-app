  ...
  return (
    <div className="min-h-screen pb-20 animate-fade-in">
      <Helmet>
        ...
        <meta name="description" content="Toilet repair in Fresno: running toilets, leaks, flush issues, clogs. Fast repairs for all brands. Licensed plumbers, 79 years experience serving Central Valley. Call (559) 275-2535!" />
      </Helmet>
