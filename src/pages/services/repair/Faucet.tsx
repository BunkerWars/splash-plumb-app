  ...
  return (
    <div className="min-h-screen pb-20 animate-fade-in">
      <Helmet>
        ...
        <meta name="description" content="Faucet repair in Fresno: fix leaks, drips, low pressure, broken handles. Kitchen & bathroom faucets. Licensed plumbers, same-day service, 79 years experience. Call (559) 275-2535!" />
      </Helmet>
