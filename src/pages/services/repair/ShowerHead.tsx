  ...
  return (
    <div className="min-h-screen pb-20 animate-fade-in">
      <Helmet>
        ...
        <meta name="description" content="Shower head repair in Fresno: fix leaks, low water pressure, clogged spray holes. Fast repairs, licensed plumbers, 79 years serving Central Valley. Call (559) 275-2535!" />
      </Helmet>
