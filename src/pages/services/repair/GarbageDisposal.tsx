      ...
      <div className="max-w-lg mx-auto px-4 py-6">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Fix jams & leaks fast</p>
          </div>
        </div>

        <div className="glass-card p-6 mb-6">
          <h2 className="text-xl font-bold text-navy mb-3">Expert Disposal Repair Services</h2>
          <p className="text-sm text-muted-foreground mb-4">
            Garbage disposal stopped working? We repair all makes and models - from simple jams to motor replacements. Fast, professional service with quality parts.
          </p>
        ...
        <div className="glass-card p-6 mb-6">
          ...
          <div className="space-y-4">
            <div className="border-l-4 border-gold pl-4">
              ...
              <p className="text-xs text-muted-foreground">Unjam disposal, reset, minor adjustments</p>
            </div>
            <div className="border-l-4 border-gold pl-4">
              <p className="font-semibold text-navy">Standard Repairs</p>
              <p className="text-2xl font-bold text-navy">$200 - $400</p>
              <p className="text-xs text-muted-foreground">Seal replacement, drain repair, flange fix</p>
            </div>
            <div className="border-l-4 border-gold pl-4">
              <p className="font-semibold text-navy">Major Repairs</p>
              <p className="text-2xl font-bold text-navy">$400 - $650</p>
              <p className="text-xs text-muted-foreground">Motor replacement, complete unit replacement</p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Fix or replace with quality parts</p>
              </div>
            </div>
            <div className="flex gap-3">
              <div className="rounded-full bg-navy p-2 h-10 w-10 flex items-center justify-center flex-shrink-0">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Ensure everything works correctly</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-navy p-6 rounded-2xl text-white space-y-3">
          ...
          <p className="text-sm opacity-90">
            Same-day repairs available. Licensed plumbers, all brands serviced, 79 years serving Fresno!
          </p>
